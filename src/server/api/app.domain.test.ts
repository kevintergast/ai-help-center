...
function makeFixture(opts: { txt?: TxtCheckResult; provision?: ProvisionResult } = {}) {
  ...
  applyMigrations(sqlite, ["0001_tenants.sql", "0021_tenant_suspend.sql", "0023_logo_dark.sql", "0025_header_name.sql", "0028_widget_on_site.sql", "0031_favicon.sql", "0002_auth.sql", "0003_branding.sql", "0013_seo_indexable.sql", "0014_support_email.sql"]);
