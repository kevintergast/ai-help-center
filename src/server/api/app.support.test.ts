...
function makeFixture(opts: { denySensitive?: boolean } = {}) {
  ...
  applyMigrations(sqlite, ["0001_tenants.sql", "0021_tenant_suspend.sql", "0023_logo_dark.sql", "0025_header_name.sql", "0028_widget_on_site.sql", "0015_support_tickets.sql"]);
