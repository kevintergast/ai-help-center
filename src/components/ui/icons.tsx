...
/** Kettenglied — Anker/Teilen-Link neben Überschriften. */
...
/** Pfeil nach rechts — dreht sich beim Aufklappen (Accordion-Block). */
...
/** Pfeil in Ablage — Datei-Anhang zum Herunterladen. */
...
/** Kalender — Kontaktweg „Termin buchen" (0048). */
