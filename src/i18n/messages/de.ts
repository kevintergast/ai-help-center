...
export const de = {
  ...
  "admin.settings.apiDocs": "API-Dokumentation (Link)",
  "admin.settings.apiDocsPlaceholder": "https://docs.deinefirma.de",
  "admin.settings.apiDocsHint": "Erscheint oben in der Navigation deines Hilfezentrums und öffnet in einem neuen Tab. Nur https. Leer lassen = kein Link.",
  "admin.settings.apiDocsSave": "Link speichern",
  "admin.settings.apiDocsSaving": "Speichert …",
  "admin.settings.apiDocsSaved": "Link gespeichert.",
  "admin.settings.apiDocsCleared": "Link entfernt.",
  "admin.settings.apiDocsInvalid": "Bitte eine vollständige https-Adresse angeben.",
