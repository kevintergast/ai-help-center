...
export const de = {
  ...
  "hc.find.position": "{current} von {total}",
  "hc.find.previous": "Vorherige Fundstelle",
  "hc.find.next": "Nächste Fundstelle",
  "hc.find.close": "Suche im Artikel beenden",
  "hc.searchClear": "Suche leeren",
  ...
  "hc.entryCards.heading": "Einstiege",
  "admin.nav.navigation": "Navigation",
  "admin.navigation.title": "Navigation & Einstieg",
  "admin.navigation.subtitle":
    "Die Reihenfolge der Leiste links und die Karten unter der KI-Eingabe auf der Startseite.",
  "admin.navOrder.title": "Reihenfolge der Artikel",
  "admin.navOrder.hint":
    "Ziehen oder mit den Pfeiltasten verschieben. Kategorien übernehmen die Position ihres ersten Artikels — wer die Artikel ordnet, ordnet auch die Kategorien. Entwürfe stehen mit in der Liste, erscheinen aber erst nach dem Veröffentlichen.",
  "admin.navOrder.empty": "Noch keine Artikel angelegt.",
  "admin.navOrder.save": "Reihenfolge speichern",
  "admin.navOrder.saved": "Reihenfolge gespeichert.",
  "admin.navOrder.unsaved": "Ungespeicherte Änderung",
  "admin.navOrder.handleAria": "{title} verschieben — Pfeil hoch/runter",
  "admin.navOrder.moveUp": "Nach oben",
  "admin.navOrder.moveDown": "Nach unten",
  "admin.navOrder.categoryUp": "Kategorie nach oben",
  "admin.navOrder.categoryDown": "Kategorie nach unten",
  "admin.entryCards.title": "Einstiegs-Karten",
  "admin.entryCards.hint":
    "Erscheinen SOFORT unter der Eingabe auf der Startseite — es gibt keinen Entwurf. Höchstens {max} Karten.",
  "admin.entryCards.empty": "Noch keine Karten. Ohne sie zeigt die Startseite nur das Eingabefeld.",
  "admin.entryCards.add": "Karte hinzufügen",
  "admin.entryCards.full": "Mehr als {max} Karten sind nicht vorgesehen.",
  "admin.entryCards.kind": "Ziel",
  "admin.entryCards.kind.article": "Artikel",
  "admin.entryCards.kind.roadmap": "Roadmap",
  "admin.entryCards.kind.changelog": "Changelog",
  "admin.entryCards.kind.url": "Externer Link",
  "admin.entryCards.cardTitle": "Titel",
  "admin.entryCards.cardTitlePlaceholder": "z. B. „Erste Schritte“",
  "admin.entryCards.description": "Beschreibung",
  "admin.entryCards.descriptionPlaceholder": "Eine kurze Zeile darunter (optional)",
  "admin.entryCards.article": "Artikel",
  "admin.entryCards.articlePlaceholder": "Artikel wählen",
  "admin.entryCards.url": "Adresse",
  "admin.entryCards.urlPlaceholder": "https://…",
  "admin.entryCards.delete": "Karte entfernen",
  "admin.entryCards.save": "Karten speichern",
  "admin.entryCards.saved": "Karten gespeichert.",
  "admin.entryCards.error.title_required": "Jede Karte braucht einen Titel.",
  "admin.entryCards.error.title_too_long": "Ein Titel ist zu lang (höchstens 80 Zeichen).",
  "admin.entryCards.error.description_too_long":
    "Eine Beschreibung ist zu lang (höchstens 160 Zeichen).",
  "admin.entryCards.error.target_required": "Einer Karte fehlt das Ziel.",
  "admin.entryCards.error.invalid_slug": "Der gewählte Artikel existiert nicht mehr.",
  "admin.entryCards.error.invalid_url": "Die Adresse muss mit https:// beginnen.",
  "admin.entryCards.error.generic": "Speichern fehlgeschlagen. Bitte noch einmal versuchen.",
  "hc.contact.navLabel": "Kontakt",
  ...
  "admin.contact.empty":
    "Noch kein Kontaktweg. Ohne einen Weg gibt es keine Kontaktseite und keinen Eintrag in der Navigation.",
  "admin.contact.add": "Kontaktweg hinzufügen",
  "admin.contact.full": "Mehr als {max} Wege sind nicht vorgesehen.",
  "admin.contact.kind": "Art",
  "admin.contact.kind.email": "E-Mail",
  "admin.contact.kind.phone": "Telefon",
  "admin.contact.kind.form": "Kontaktformular",
  "admin.contact.methodTitle": "Überschrift",
  "admin.contact.methodTitlePlaceholder": "z. B. „Support schreiben“",
  "admin.contact.description": "Beschreibung",
  "admin.contact.descriptionPlaceholder": "z. B. „Antwort meist am selben Werktag“ (optional)",
  "admin.contact.email": "E-Mail-Adresse",
  "admin.contact.phone": "Rufnummer",
  "admin.contact.formNote":
    "Das Formular schickt die Nachricht als Ticket ins Postfach — wie der Meldeweg unter den KI-Antworten.",
  "admin.contact.delete": "Kontaktweg entfernen",
  "admin.contact.save": "Kontaktwege speichern",
  "admin.contact.saved": "Kontaktwege gespeichert.",
  "admin.contact.error.title_required": "Jeder Kontaktweg braucht eine Überschrift.",
  "admin.contact.error.title_too_long": "Eine Überschrift ist zu lang (höchstens 80 Zeichen).",
  "admin.contact.error.description_too_long":
    "Eine Beschreibung ist zu lang (höchstens 200 Zeichen).",
  "admin.contact.error.value_required": "Einem Kontaktweg fehlt die Adresse bzw. die Nummer.",
  "admin.contact.error.invalid_email": "Das ist keine gültige E-Mail-Adresse.",
  "admin.contact.error.invalid_phone": "Das ist keine gültige Rufnummer.",
  "admin.contact.error.generic": "Speichern fehlgeschlagen. Bitte noch einmal versuchen.",
  "admin.footer.title": "Fuß des Hilfezentrums",
  "admin.footer.hint":
    "Die schmale Zeile ganz unten. Rechtstexte erscheinen nur, wenn du sie hier anhakst — danach folgen deine eigenen Links.",
  "admin.footer.legalHeading": "Rechtstexte",
  "admin.footer.legalHint":
    "Den Inhalt pflegst du unter Einstellungen → Rechtstexte. Hier entscheidest du nur, ob der Link im Fuß steht.",
  "admin.footer.privacyWarning":
    "Die Datenschutzerklärung gehört auf jede Instanz: Sobald jemand dein Hilfezentrum aufruft, werden personenbezogene Daten verarbeitet (Art. 13 DSGVO).",
  "admin.footer.linksHeading": "Eigene Links",
  "admin.footer.linksHint": "Höchstens {max} — z. B. Status-Seite, Hauptwebsite oder Barrierefreiheit.",
  "admin.footer.empty": "Noch kein eigener Link.",
  "admin.footer.add": "Link hinzufügen",
  "admin.footer.label": "Beschriftung",
  "admin.footer.labelPlaceholder": "z. B. „Status“",
  "admin.footer.href": "Ziel",
  "admin.footer.hrefPlaceholder": "https://… oder /contact",
  "admin.footer.delete": "Link entfernen",
  "admin.footer.poweredBy": "„Powered by HallofHelp“ im Fuß zeigen",
  "admin.footer.save": "Fuß speichern",
  "admin.footer.saved": "Fuß gespeichert.",
  "admin.footer.adminOnly": "Nur Admins und der Owner können den Fuß ändern.",
  "admin.footer.error.label_required": "Jeder Link braucht eine Beschriftung.",
  "admin.footer.error.label_too_long": "Eine Beschriftung ist zu lang (höchstens 32 Zeichen).",
  "admin.footer.error.href_required": "Einem Link fehlt das Ziel.",
  "admin.footer.error.invalid_href":
    "Ziele müssen mit https:// beginnen oder ein Pfad dieser Instanz sein (z. B. /contact).",
  "admin.footer.error.generic": "Speichern fehlgeschlagen. Bitte noch einmal versuchen.",
  "admin.headerActions.title": "Aktions-Knöpfe im Kopf",
  "admin.headerActions.hint":
    "Erscheinen SOFORT oben rechts im Hilfezentrum, auf jeder Seite. Höchstens {max}. Gut für die eine Handlung, die überall erreichbar sein soll — Termin buchen, Statusseite, Demo.",
  "admin.headerActions.empty": "Noch kein Knopf. Der Kopf zeigt dann nur die Standard-Bedienelemente.",
  "admin.headerActions.add": "Knopf hinzufügen",
  "admin.headerActions.label": "Beschriftung",
  "admin.headerActions.labelPlaceholder": "z. B. „Termin buchen“",
  "admin.headerActions.href": "Ziel",
  "admin.headerActions.hrefPlaceholder": "https://… oder /contact",
  "admin.headerActions.icon": "Symbol (optional)",
  "admin.headerActions.iconNone": "Kein Symbol",
  "admin.headerActions.variant": "Variante",
  ...
  "admin.headerActions.variant.colored": "Colored (Markenfarbe)",
  "admin.headerActions.preview": "So sieht er aus:",
  "admin.headerActions.delete": "Knopf entfernen",
  "admin.headerActions.save": "Knöpfe speichern",
  "admin.headerActions.saved": "Knöpfe gespeichert.",
  "admin.headerActions.error.label_required": "Jeder Knopf braucht eine Beschriftung.",
  "admin.headerActions.error.label_too_long": "Eine Beschriftung ist zu lang (höchstens 24 Zeichen).",
  "admin.headerActions.error.href_required": "Einem Knopf fehlt das Ziel.",
  "admin.headerActions.error.invalid_href":
    "Das Ziel muss mit https:// beginnen oder ein interner Pfad wie /contact sein.",
  "admin.headerActions.error.generic": "Speichern fehlgeschlagen. Bitte noch einmal versuchen.",
  "hc.comprehension.start": "Ich verstehe etwas nicht",
  "hc.comprehension.stop": "Modus beenden",
  "hc.comprehension.explainTitle": "Zeig uns die Stelle",
  "hc.comprehension.explainBody":
    "Gleich kannst du im Artikel auf die Stelle klicken, die du nicht verstehst — einen Absatz, ein Bild, eine Tabelle. Danach schreibst du kurz, was unklar ist. Mit Escape brichst du jederzeit ab.",
  "hc.comprehension.continue": "Weiter",
  "hc.comprehension.cancel": "Abbrechen",
  "hc.comprehension.back": "Zurück",
  "hc.comprehension.commentTitle": "Was ist hier unklar?",
  "hc.comprehension.commentLabel": "Dein Hinweis",
  "hc.comprehension.commentPlaceholder": "z. B. „Was bedeutet dieser Begriff?“ (mindestens 5 Zeichen)",
  "hc.comprehension.emailTitle": "Sollen wir dir antworten?",
  "hc.comprehension.emailBody":
    "Freiwillig. Mit einer Adresse kann sich das Team bei dir melden — ohne geht dein Hinweis anonym raus.",
  "hc.comprehension.emailPlaceholder": "du@beispiel.de",
  "hc.comprehension.send": "Mit Adresse senden",
  "hc.comprehension.sendAnonymous": "Ohne Adresse senden",
  "hc.comprehension.sentTitle": "Danke!",
  "hc.comprehension.sentBody": "Dein Hinweis ist angekommen. Wir schauen uns die Stelle an.",
  "hc.comprehension.close": "Schließen",
  "hc.comprehension.error.short": "Bitte schreib ein paar Worte mehr.",
  "hc.comprehension.error.email": "Das ist keine gültige E-Mail-Adresse.",
  "hc.comprehension.error.failed": "Senden fehlgeschlagen. Bitte noch einmal versuchen.",
  "hc.comprehension.dialogClose": "Dialog schließen",
  ...
  "admin.widget.appearanceHint":
    "So sieht der Starter auf der Website deiner Kunden aus. Dieselben vier Varianten wie bei den Kopf-Knöpfen. Im Kopf des Widgets steht automatisch dein Logo.",
  "admin.widget.label": "Beschriftung (optional)",
  "admin.widget.labelPlaceholder": "z. B. „Hilfe“ — leer = nur das Symbol",
  "admin.widget.iconClosed": "Symbol, geschlossen",
  "admin.widget.iconOpen": "Symbol, geöffnet",
  "admin.widget.iconHint": "PNG, JPEG oder WebP. Am besten 96×96 px mit transparentem Hintergrund.",
  "admin.widget.iconRejected":
    "Dieses Format nehmen wir nicht an. Erlaubt sind PNG, JPEG und WebP — SVG bewusst nicht, weil es Skripte enthalten kann.",
  "admin.widget.choose": "Bild wählen",
  ...
  "admin.suggestions.position": "Vorschlag {n}",
  "admin.suggestions.placeholder": "z. B. „Wie setze ich mein Passwort zurück?“",
  "admin.suggestions.add": "Vorschlag hinzufügen",
  "admin.suggestions.delete": "Vorschlag entfernen",
  "admin.suggestions.save": "Vorschläge speichern",
  "admin.suggestions.saved": "Vorschläge gespeichert.",
  "admin.suggestions.full": "Mehr als {max} sind nicht vorgesehen.",
  "admin.suggestions.error.tooLong": "Ein Vorschlag ist zu lang (höchstens 100 Zeichen).",
  "admin.suggestions.error.generic": "Speichern fehlgeschlagen. Bitte noch einmal versuchen.",
  // FARBWELT / Theme-Generator (0045). Die Token-Namen sind bewusst deutsch
  // und nicht die CSS-Variable: Wer hier arbeitet, denkt in „Inhaltsfläche",
  // nicht in „--surface". Die Variable steht als Zusatz darunter.
  "admin.settings.colorsViaTheme":
    "Diese Instanz hat eine eigene Farbwelt. Marken- und Akzentfarbe werden dort gepflegt — hier eingetragene Werte hätten im Hilfezentrum keine Wirkung.",
  "admin.settings.colorsViaThemeLink": "Zur Farbwelt",
  "admin.nav.design": "Farbwelt",
  "admin.theme.title": "Farbwelt",
  "admin.theme.subtitle": "Farben des Hilfezentrums für Hell und Dunkel bestimmen.",
  "admin.theme.generator.title": "Farbwelt erzeugen",
  "admin.theme.generator.hint":
    "Vier Angaben genügen: Daraus entsteht ein vollständiger Satz für Hell UND Dunkel, dessen Kontraste geprüft sind.",
  "admin.theme.anchor.brand": "Markenfarbe",
  "admin.theme.anchor.accent": "Akzentfarbe",
  "admin.theme.anchor.neutral": "Grundton der Grautöne",
  "admin.theme.anchor.surface": "Flächen",
  "admin.theme.neutral.cool": "Kühl",
  "admin.theme.neutral.neutral": "Neutral",
  "admin.theme.neutral.warm": "Warm",
  "admin.theme.surface.plain": "Rein",
  "admin.theme.surface.tinted": "Getönt",
  "admin.theme.generate": "Farbwelt erzeugen",
  "admin.theme.generateHint": "Überschreibt beide Modi. Danach lässt sich jeder Wert einzeln ändern.",
  "admin.theme.tune.title": "Feinjustierung",
  "admin.theme.tune.hint":
    "Hell und Dunkel werden getrennt gepflegt — eine Änderung hier fasst den anderen Modus nicht an.",
  "admin.theme.mode.light": "Hell",
  "admin.theme.mode.dark": "Dunkel",
  "admin.theme.group.surfaces": "Flächen",
  "admin.theme.group.text": "Text",
  "admin.theme.group.lines": "Linien",
  "admin.theme.group.brand": "Marke",
  "admin.theme.group.button": "Hochkontrast-Knopf",
  "admin.theme.group.semantic": "Statusfarben",
  "admin.theme.token.page": "Seitengrund",
  "admin.theme.token.surface": "Inhaltsfläche",
  "admin.theme.token.surface2": "Angehobene Fläche",
  "admin.theme.token.tint": "Tönung bei Hover",
  "admin.theme.token.ink": "Textfarbe",
  "admin.theme.token.muted": "Gedämpfter Text",
  "admin.theme.token.border": "Linie",
  "admin.theme.token.borderStrong": "Kräftige Linie",
  "admin.theme.token.brandPrimary": "Markenfarbe",
  "admin.theme.token.brandAccent": "Akzentfarbe",
  "admin.theme.token.brandPrimaryFg": "Schrift auf der Marke",
  "admin.theme.token.btnPrimaryBg": "Knopf-Fläche",
  "admin.theme.token.btnPrimaryFg": "Knopf-Schrift",
  "admin.theme.token.semInfo": "Hinweis",
  "admin.theme.token.semInfoBg": "Hinweis-Fläche",
  "admin.theme.token.semOk": "Erfolg",
  "admin.theme.token.semOkBg": "Erfolg-Fläche",
  "admin.theme.token.semOkBd": "Erfolg-Linie",
  "admin.theme.token.semWarn": "Warnung",
  "admin.theme.token.semWarnBg": "Warnung-Fläche",
  "admin.theme.token.semWarnBd": "Warnung-Linie",
  "admin.theme.token.semCrit": "Fehler",
  "admin.theme.token.semCritBg": "Fehler-Fläche",
  "admin.theme.token.semCritBd": "Fehler-Linie",
  "admin.theme.preview.title": "Vorschau",
  "admin.theme.preview.heading": "So sieht ein Artikel aus",
  "admin.theme.preview.body":
    "Fließtext in gedämpfter Schrift — das ist die Farbe, an der Lesbarkeit zuerst scheitert.",
  "admin.theme.preview.field": "Eingabefeld",
  "admin.theme.preview.primary": "Marken-Knopf",
  "admin.theme.preview.secondary": "Zweitknopf",
  "admin.theme.preview.contrastButton": "Hauptaktion",
  "admin.theme.preview.badgeInfo": "Hinweis",
  "admin.theme.preview.badgeOk": "Erfolg",
  "admin.theme.preview.badgeWarn": "Warnung",
  "admin.theme.preview.badgeCrit": "Fehler",
  "admin.theme.contrast.title": "Kontrast",
  "admin.theme.contrast.hint":
    "Geprüft werden nur Paare, die im Hilfezentrum wirklich übereinanderliegen. Text braucht 4,5:1.",
  "admin.theme.contrast.pair": "{fg} auf {bg}",
  "admin.theme.contrast.allOk": "Alle geprüften Paare sind ausreichend.",
  "admin.theme.contrast.problems": "{n} Paar(e) unter der Schwelle — lesbar ist das nicht überall.",
  "admin.theme.contrast.warnLabel": "Kontrast unter der Schwelle",
  "admin.theme.save": "Farbwelt speichern",
  "admin.theme.saved": "Gespeichert.",
  "admin.theme.reset": "Auf Standard zurücksetzen",
  "admin.theme.active": "Eigene Farbwelt ist aktiv.",
  "admin.theme.inactive": "Noch nicht gespeichert — es gilt das Standard-Theme.",
  "admin.theme.error.generic": "Speichern fehlgeschlagen.",
  ...
  "admin.plan.mauHint":
    "Ohne Cookie gezählt, damit dein Hilfezentrum kein Einwilligungs-Banner braucht: Aus Adresse und Browser entsteht ein Kürzel, das nur diesen Monat und nur hier gilt.",
  ...
  "admin.legal.privacyMissing":
    "Die Datenschutzerklärung fehlt noch. Sie gehört auf jede Instanz: Sobald jemand dein Hilfezentrum aufruft, werden personenbezogene Daten verarbeitet (Art. 13 DSGVO).",
  ...
  "admin.settings.faviconHint": "Optional — quadratisches Emblem, mindestens 64×64. Ohne eigenes Favicon nutzt der Tab automatisch dein helles Logo.",
  ...
  "admin.settings.faviconBadType": "Nur PNG, JPEG, WebP oder ICO.",
  ...
  "editor.blocks.type.cardGrid": "Verweis-Gitter",
  "editor.blocks.cardGridHint": "Mehrere Artikel-Verweise nebeneinander — für Abschnitte wie \u00bbWeitere Features\u00ab.",
  "editor.blocks.cardGridItem": "Karte",
  "editor.blocks.cardGridAdd": "Karte hinzufügen",
  "editor.blocks.cardGridRemove": "Entfernen",
  ...
  "editor.blocks.color.info": "Blau (Hinweis)",
  ...
  "editor.icon.label": "Symbol in der Navigation",
  "editor.icon.none": "Kein Symbol",
  "editor.icon.hint":
    "Optional. Ohne Symbol steht in der Leiste nur der Titel — das ist der Standard und für die meisten Artikel richtig.",
