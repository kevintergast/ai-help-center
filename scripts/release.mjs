...
function main() {
  ...
  console.log(
    [
      ...
      `  4. Nach dem Merge nach main: pnpm tag  (setzt v${version} und pusht ihn)`,
      "     Die CI versucht es auch selbst; hat ihr Token keine Schreibrechte,",
      "     bleibt sie grün und weist auf `pnpm tag` hin.",
