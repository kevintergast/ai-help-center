...
const ARTICLES = [
  ...
  },
  {
    ...
    min: 2,
    body: [
      "Manche Anliegen klärt kein Artikel, sondern ein Gespräch. Unter „Einstellungen → Buchungslink“ hinterlegst du die Adresse deines Buchungskalenders — cal.com, Calendly, Microsoft Bookings, was du nutzt. Dazu eine Überschrift („Noch Fragen?“), die Beschriftung des Knopfes („Termin buchen“) und optional eine kurze Zeile darunter („15 Minuten, unverbindlich“).",
      ...
      "Auch das lässt sich über einen angebundenen KI-Client setzen. Weil der Link sofort öffentlich wirkt, hängt das am Recht »Changelog und Roadmap pflegen«, nicht am reinen Schreibrecht für Artikel.",
    ],
